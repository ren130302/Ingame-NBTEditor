...
import net.minecraft.world.inventory.Slot;
 ...
 public class HearthScreen extends ContainerScreen<HearthContainer> implements IRecipeShownListener {
    ...
    public final RecipeBookGui book = new RecipeBookGui();
    ...
    public void init() {
       ...
       this.addButton(new ImageButton(this.field_147003_i + 5, this.height / 2 - 49, 20, 18, 0, 0, 19, BOOK_BUTTON, (button) -> {
    ...
    protected void func_146976_a(float partialTicks, int mouseX, int mouseY) {
       ...
       this.blit(k + 90, l + 35, 176, 0, 23 - (int)(23.0F * this.progress()), 16);
    }
 
    private float progress() {
       int total = ((HearthContainer)this.func_212873_a_()).getCooktime();
       int now = ((HearthContainer)this.func_212873_a_()).getProgress();
       return total != 0 && now >= 0 ? (float)((HearthContainer)this.func_212873_a_()).getProgress() / (float)((HearthContainer)this.func_212873_a_()).getCooktime() : 1.0F;
    }
