...
public class ModLogger {
	...
	private ModLogger(Class<?> clazz) {
		...
		final PatternLayout layout = PatternLayout.newBuilder().withPattern("[%d{MM-dd HH:mm:ss}] [%level]: %msg%n")
				.build();
		final FileAppender appender = FileAppender.newBuilder().withFileName("logs/" + clazz.getName() + ".log")
