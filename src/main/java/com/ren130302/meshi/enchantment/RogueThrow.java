...
public class RogueThrow extends BMEnchantmentBase {
    public RogueThrow(Rarity rarity, EnchantmentCategory category, EquipmentSlot[] slots) {
	...
	return (ench instanceof CriticalThrow || ench instanceof PoisonThrow || ench instanceof AssassinThrow) ? false
